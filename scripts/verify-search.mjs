...
const COMBOS = [
  ...
  ["楽しみたい", "王道で遊ぶ", /遊園地|パーク|ランド|カラオケ|テーマ|ジョイポリ|レジャー|ワールド|キッズ|ゲーム|GiGO|ナムコ|アミューズ|ボウル|ファンタジー|大世界|プラネット|科学館|宇宙|動物園|水族館|広場|アドベンチャー|NICOPA|ニコパ|モーリー|TOYLO/i, "今日は出かけたい"],
