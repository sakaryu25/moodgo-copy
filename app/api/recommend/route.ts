...
const GENRE_NEGATIVE_RE: Record<string, RegExp> = {
  ...
  "知らない街をぶらぶら": /スーパー|まいばすけっと|マルエツ|ライフ|オーケー|コンビニ|セブン|ファミリーマート|ローソン|ドラッグ|薬局|公園|緑地|樹林|動物園|植物園|霊園|墓地|駐車場|グラウンド|運動場|ゴルフ|キャンプ|河川敷|広場|スポーツ|ジム|フットサル|ボルダリング|バッティング|ラケット|ダイビング|スキューバ|フィットネス|スイミング|プール|テニス|体育館|アスレチック|サッカー|野球場|FUTSAL|SPORTS|FITNESS|SWING|BATTING|TENNIS|BOWL/i,
...
const GENRE_POSITIVE_REQUIRED: Record<string, RegExp> = {
  ...
  "知らない街をぶらぶら": /商店街|横丁|中華街|通り|市場|街|ストリート|小町|仲見世|門前|参道|銀座|マーケット|モール|タウン|レンガ|ドックヤード|ガード下/i,
  "知らない町へ":         /商店街|横丁|中華街|通り|市場|街|ストリート|小町|仲見世|門前|参道|銀座|マーケット|モール|タウン|レンガ|ドックヤード|ガード下/i,
  "お散歩":               /商店街|横丁|中華街|通り|市場|街|ストリート|小町|仲見世|門前|参道|銀座|マーケット|モール|タウン|レンガ|ドックヤード|ガード下/i,
};
