...
async function fetchYahooSupplement(
  ...
  const DIVE_KW: Record<string, string> = {
    ...
    "景色良いカフェ":               "景色カフェ 海辺カフェ 森林カフェ 高層カフェ 展望カフェ",
    "景色が良いカフェ":             "景色カフェ 海辺カフェ 森林カフェ",  // 旧キー（後方互換）
    ...
    "外でひろびろ":                 "大きな公園 フィールドアスレチック アスレチック",
    "室内でのんびり":               "バッティングセンター 卓球 ボウリング ビリヤード ダーツ",
    "ゲーム感覚で":                 "ボウリング カラオケ ビリヤード ダーツ スポッチャ トランポリン",
    // ── 運動 L1 (旧キー・後方互換) ───────────────────────────────────────
