...
const GENRE_NEGATIVE_RE: Record<string, RegExp> = {
  ...
  "知らない街をぶらぶら": /公園|緑地|樹林|動物園|植物園|霊園|墓地|駐車場|グラウンド|運動場|ゴルフ|キャンプ|河川敷|広場|スポーツ|ジム|フットサル|ボルダリング|バッティング|ラケット|ダイビング|スキューバ|フィットネス|スイミング|プール|テニス|体育館|アスレチック|サッカー|野球場/i,
  "知らない町へ":        /公園|緑地|樹林|動物園|植物園|霊園|墓地|駐車場|グラウンド|運動場|ゴルフ|キャンプ|河川敷|広場|スポーツ|ジム|フットサル|ボルダリング|バッティング|ラケット|ダイビング|スキューバ|フィットネス|スイミング|プール|テニス|体育館|アスレチック|サッカー|野球場/i,
  "お散歩":             /公園|緑地|樹林|動物園|植物園|霊園|墓地|駐車場|グラウンド|運動場|ゴルフ|キャンプ|河川敷|広場|スポーツ|ジム|フットサル|ボルダリング|バッティング|ラケット|ダイビング|スキューバ|フィットネス|スイミング|プール|テニス|体育館|アスレチック|サッカー|野球場/i,
