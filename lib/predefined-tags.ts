...
export const TAG_CATEGORIES: TagCategory[] = [
  ...
  },
  {
    label: "#焼肉 深掘り",
    key: "yakinikuSub",
    tags: ["#焼肉食べ放題", "#高級焼肉", "#ホルモン焼き", "#ジンギスカン焼き"],
  },
  {
    label: "#アジア系統 深掘り",
    key: "asianSub",
  ...
  // ── その他気分 深掘り ─────────────────────────────────────────────────────
  {
    label: "#わいわい楽しみたい 深掘り",
    key: "waiWaiSub",
    tags: ["#体動かしたい", "#アミューズメントパーク", "#体験型ゲーム", "#居酒屋"],
  },
  {
    label: "#体験型ゲーム 深掘り",
    key: "gameDetailSub",
    tags: ["#カラオケ", "#ダーツ", "#ビリヤード", "#ボウリング"],
  },
  {
    label: "#自然感じたい 深掘り",
    key: "natureMoodSub",
  ...
  },
  {
    label: "#体動かしたい 深掘り",
    key: "sportsSub",
    tags: ["#ガッツリ運動", "#スポーツ", "#体験型ゲーム", "#屋外スポーツ"],
  },
  {
    label: "#遠くに行きたい 深掘り",
    key: "travelSub",
