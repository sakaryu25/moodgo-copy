...
export function extractUserTagsFromAnswers(answers: {
  ...
  const DRILL_ANSWER_TO_MUST: Record<string, string[]> = {
    ...
    // ── まったりしたい L2 (カフェ sub) — 新キー（全てAPI-only）
    "ブックカフェ・隠れカフェ": [],  // API-only（Google でブックカフェ検索）
    ...
    // ── 集中したい L1 — 新キー
    "カフェで作業・勉強したい":       [],  // API-only（ファミレス・スタバ等はGoogleで検索）
