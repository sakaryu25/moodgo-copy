...
function getKodawaranaiTags(
  ...
  // ── ドライブしたい ────────────────────────────────────────────────────────
  if (m.includes("ドライブ")) {
    return ["#海辺", "#絶景スポット", "#展望台", "#お散歩", "#ご当地グルメ", "#ショッピング"];
  }

  // ── 集中したい ────────────────────────────────────────────────────────────
  if (m.includes("集中")) {
    // API-only 系も含むため Supabase タグは静かな系のみ
  ...
  if (m.includes("旅行") || m.includes("遠く")) {
    return ["#パワースポット", "#テーマパーク", "#ご当地グルメ", "#お散歩", "#絶景スポット", "#展望台"];
  }
