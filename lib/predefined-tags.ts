...
export function extractUserTagsFromAnswers(answers: {
  ...
  const DRILL_ANSWER_TO_MUST: Record<string, string[]> = {
    ...
    // ── 体動かしたい L1 — 新キー
    "がっつり汗を流してトレーニング": ["#体動かしたい", "#ガッツリ運動", "#スポーツ", "#体験型ゲーム", "#屋外スポーツ"],
    "打って投げてストレス発散":       ["#スポーツ"],  // + API（バッティング・ゴルフ）
    "遊び感覚でわいわい":             ["#わいわい楽しみたい", "#アミューズメントパーク", "#体験型ゲーム", "#テーマパーク"],
    "外で風を感じながらスポーツ":     ["#自然公園", "#大型公園", "#屋外スポーツ"],
