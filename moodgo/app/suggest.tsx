...
const MOODS = [
  ...
  '#ドライブしたい', '#集中したい', '#体動かしたい', '#遠くに行きたい', '#ショッピング',
  '#スリル味わいたい',
];

// L2: 気分タグ → 深掘りタグ
const MOOD_DRILL: Record<string, string[]> = {
  '#お腹すいた':         ['#居酒屋', '#和食', '#洋食', '#イタリアン', '#中華', '#焼肉', '#韓国', '#アジア系統', '#各国料理', '#ラーメン', '#お好み焼きもんじゃ', '#カフェスイーツ', '#高層ビル料理'],
  '#まったりしたい':     ['#自然感じたい', '#癒しカフェ', '#温泉', '#絶景スポット'],
  '#わいわい楽しみたい': ['#テーマパーク', '#体験型ゲーム', '#鑑賞', '#ものつくり'],
  '#自然感じたい':       ['#海辺', '#自然公園', '#大型公園', '#展望台'],
  '#ドライブしたい':     ['#海辺', '#絶景スポット', '#ショッピング', '#ご当地グルメ', '#道の駅'],
  '#集中したい':         ['#カフェ作業', '#勉強場', '#ファミレス', '#book場'],
  '#体動かしたい':       ['#ガッツリ運動', '#外で運動', '#室内で運動', '#ゲーム感覚で運動'],
  '#遠くに行きたい':     ['#パワースポット', '#テーマパーク', '#お散歩', '#絶景スポット'],
  '#ショッピング':       ['#服アクセサリー', '#雑貨インテリア', '#コスメ美容', '#ショッピング', '#お土産ギフト'],
  '#スリル味わいたい':   ['#絶叫', '#心霊スポット', '#高所', '#体験型'],
};
