...
// つぶやき（グループチャット）— 吹き出しに3点ドット
function IconChat({ active }: { active: boolean }) {
  const fill = active ? ACTIVE : INACTIVE;
  return (
    <Svg width={26} height={26} viewBox="0 0 24 24" fill={fill}>
      <Path fillRule="evenodd" clipRule="evenodd" d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM7.5 11.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5S9 9.17 9 10s-.67 1.5-1.5 1.5zm4.5 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4.5 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
    </Svg>
  );
}
