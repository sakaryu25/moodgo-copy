...
const FREE_WORD_HINTS: Record<string, string[]> = {
  'お腹すいた': ['インスタ映え', '食べ放題', '個室あり', 'テラス席', 'コスパ重視', '深夜営業'],
  'まったり':   ['景色が良い', 'ペット可', '読書できる', '長居OK', '隠れ家的', 'のんびりできる'],
  'わいわい':   ['大人数OK', '写真映え', '夜まで遊べる', '体を動かす', 'イベント', '盛り上がれる'],
  '自然':       ['絶景', '海が見たい', '森の中', '川沿い', '山登り', '夕日が綺麗'],
  'ドライブ':   ['海沿いの道', '夜景スポット', '峠・ワインディング', 'アウトレット', 'ご当地グルメ', '絶景展望台'],
  '集中':       ['Wi-Fi完備', '電源あり', '静かな席', '長時間OK', '個室・半個室', '混まない'],
  '運動':       ['初心者OK', '本格的に', '仲間と', '一人でも', '屋外で', '汗をかきたい'],
  '旅行':       ['パワースポット', '温泉', '絶景', '穴場スポット', '世界遺産', 'フォトジェニック'],
  '時間潰し':   ['近所で', 'のんびり', '無料', '24時間', 'ショッピング', '映画・エンタメ'],
};

const FREE_WORD_HINTS_DEFAULT = ['夜景', '海が見たい', '甘いもの', '静かな場所', '公園', '穴場スポット'];
