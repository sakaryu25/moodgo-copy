...
const DEEP_DIVE: Record<string, DiveConfig> = {
  ...
  'まったり': {
    ...
    options: [
      ...
      { key: 'カフェ',     label: '癒しカフェ', sub: 'のんびりくつろぐ',      Icon: Coffee,
        subs: [
          { key: 'ブックカフェ・隠れカフェ', label: 'ブックカフェ・隠れカフェ', Icon: BookOpen },
          { key: '絶品スイーツカフェ',       label: '絶品スイーツカフェ',       Icon: Star },
        ],
      },
      { key: '動物カフェ', label: '動物カフェ', sub: '猫・犬・小動物と触れ合う', Icon: Heart,
        subs: [
      ...
      { key: '景色良いカフェ', label: '景色良いカフェ', sub: '絶景を眺めながらくつろぐ', Icon: Camera,
        subs: [
      ...
      { key: '温泉スパ',   label: '温泉・スパ', sub: '体の芯からリラックス',   Icon: Waves,
        subs: [
  ...
  '自然': {
    ...
    options: [
      ...
      { key: '広い芝生でゴロゴロ', label: '広い芝生でゴロゴロ', sub: '広々した大型公園',     Icon: Leaf },
      { key: '圧倒的な絶景',       label: '圧倒的な絶景',       sub: '展望台・絶景スポット', Icon: Mountain },
      { key: 'こだわらない',       label: 'こだわらない',       sub: 'なんでもOK',           Icon: Shuffle },
    ],
  },
  ...
  'ドライブ': {
    ...
    options: [
      ...
      { key: '道の駅でご当地グルメ',           label: '道の駅・ご当地グルメ', sub: '地元の名物料理',     Icon: UtensilsCrossed },
      { key: '郊外の大型施設に行きたい',       label: '郊外の大型施設',     sub: 'アウトレット・モール', Icon: ShoppingBag },
      { key: 'こだわらない',                   label: 'こだわらない',       sub: 'なんでもOK',           Icon: Shuffle },
    ],
  },
  ...
  '運動': {
    title: 'どんな風に体を動かしたい？',
    options: [
      { key: 'がっつり汗を流してトレーニング', label: 'がっつりトレーニング', sub: 'ジム・プール・スポーツセンター', Icon: Dumbbell },
      { key: '打って投げてストレス発散',       label: '打って投げてスカッと', sub: 'バッティング・ゴルフ',          Icon: Trophy },
      { key: '遊び感覚でわいわい',             label: '遊び感覚でわいわい',   sub: 'ボウリング・ゲーム系',          Icon: Gamepad2 },
      { key: '外で風を感じながらスポーツ',     label: '外でのびのびスポーツ', sub: '公園・屋外スポーツ',            Icon: Activity },
      { key: 'こだわらない',                   label: 'こだわらない',         sub: 'なんでもOK',                    Icon: Shuffle },
    ],
  },
  ...
  '旅行': {
    ...
    options: [
      ...
      { key: '別世界のテーマパーク', label: '別世界のテーマパーク', sub: '大型施設で楽しむ',   Icon: Star },
      { key: '知らない街をぶらぶら', label: '知らない街をぶらぶら', sub: 'ご当地グルメ・街歩き', Icon: Footprints },
